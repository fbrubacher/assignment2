...
if __name__ == '__main__':
    ...
    parser.add_argument('--mlrose', action='store_true', help='Run all experiments')
    # ANNMlRose
    ...
    ds1_details = {
        ...
        'name': 'ufc',
        'readable_name':'UFC matches',
    }

    # ds1_details = {
    #         'data': loader.AdultEarnings(verbose=verbose, seed=seed),
    #         'name': 'adult_earnings',
    #         'readable_name': 'Adult Earnings',
    #     }
    ds2_details = {
    ...
    if args.mlrose or args.all:
        run_experiment(experiment_details, experiments.MLRoseExperiment, 'MLRose', verbose, timings)
